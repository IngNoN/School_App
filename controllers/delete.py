...
def delete_teacher():
    ...
    if DeleteItemData.validate_on_submit:
        ...
        teacher_to_delte = db.session.query(Teacher).filter(
            Teacher.teacher_Id == teacher_Id_to_delete)
...
delete_department_manager_blueprint = Blueprint(
    "delete_department_manager_blueprint", __name__)
...
def delete_department_manager():
    ...
    if DeleteItemData.validate_on_submit:
        ...
        department_manager_to_delte = db.session.query(DepartmentManager).filter(
            DepartmentManager.departmentManager_Id == department_manager_Id_to_delete)
...
delete_group_of_teachers_blueprint = Blueprint(
    "delete_group_of_teachers_blueprint", __name__)
...
def delete_group_of_teachers():
    ...
    if DeleteItemData.validate_on_submit:
        ...
        group_of_teachers_to_delte = db.session.query(GroupOfTeacher).filter(
            GroupOfTeacher.group_of_teachers_Id == group_of_teachers_Id_to_delete)
...
delete_teacher_in_group_blueprint = Blueprint(
    "delete_teacher_in_group_blueprint", __name__)
...
def delete_teacher_in_group():
    ...
    if DeleteItemData.validate_on_submit:
        ...
        teacher_in_group_to_delete = db.session.query(TeacherInGroup).filter(
            TeacherInGroup.teacher_in_group_Id == teacher_in_group_Id_to_delete)
